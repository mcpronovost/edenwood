...
class EdwAuthTokenSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        raise NotImplementedError("EdwAuthTokenSerializer is read-only")
...
class EdwAuthRegisterSerializer(serializers.ModelSerializer):
    username = serializers.CharField(
        write_only=True,
        required=True,
        validators=[
...
class EdwUserSerializer(serializers.ModelSerializer):
    class Meta:
        model = get_user_model()
...
class EdwGameUserAuthorSerializer(serializers.ModelSerializer):
    class Meta:
        model = get_user_model()
