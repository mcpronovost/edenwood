...
from .models import EdwUser, EdwAuthToken


@admin.register(EdwUser)
class EdwUserAdmin(UserAdmin, ModelAdmin):
    form = UserChangeForm
...
@admin.register(EdwAuthToken)
class EdwAuthTokenAdmin(ModelAdmin):
