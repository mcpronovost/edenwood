...
from edenwood.contrib.auth.serializers import (
    EdwAuthTokenSerializer,
    EdwAuthRegisterSerializer,
    EdwUserSerializer,
)


class EdwAuthLoginView(KnoxLoginView):
    """
    Login a user
    """
    ...
    def post(self, request, *args, **kwargs):
        serializer = EdwAuthTokenSerializer(data=request.data)
...
class EdwAuthLogoutView(KnoxLogoutView):
    """
...
class EdwAuthLogoutAllView(KnoxLogoutAllView):
    """
...
class EdwAuthRegisterView(EdwAuthLoginView):
    """
    Register a new user and log them in automatically
    """

    def post(self, request, *args, **kwargs):
        serializer = EdwAuthRegisterSerializer(data=request.data)
